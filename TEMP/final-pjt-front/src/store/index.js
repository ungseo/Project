...
export default new Vuex.Store({
  state: {
    ...
    PROFILE_IMG_URL: require('@/assets/logo.png')
  },
  getters: {
  ...
  mutations: {
    ...
    CHANGE_PROFILE_IMG(state, img_path) {
      console.log(img_path)
      state.PROFILE_IMG_URL = img_path
      console.log(state.PROFILE_IMG_URL)
    },
  ...
  actions: {
    ...
    changeProfileImg(context, img_path) {
      context.commit("CHANGE_PROFILE_IMG", img_path)
